...
- Otherwise write a SKILL.md / agent file inline with frontmatter, location, and contents. **CRITICAL:** You must save the new SKILL.md in BOTH `.claude/skills/<name>/SKILL.md` AND `.agents/skills/<name>/SKILL.md` so it works for both Claude Code and Antigravity.
