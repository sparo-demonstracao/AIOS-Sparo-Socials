// render-pdf.mjs — gera o PDF da proposta da Xtreme a partir do proposta-en.html (Letter).
...
await page.goto(pathToFileURL(path.join(HERE, 'proposta-en.html')).href, { waitUntil: 'networkidle' });
...
await page.pdf({
  path: path.join(HERE, 'Sparo-Xtreme-AI-Automation-Proposal.pdf'),
  format: 'Letter',
  printBackground: true,
});
console.log('ok Sparo-Xtreme-AI-Automation-Proposal.pdf');
await browser.close();
