...
This framework is the operator brain you'll use every time you run `/automatize-se`. Three layers, each one builds on the last. Read it once, refer back as needed.
